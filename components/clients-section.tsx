...
export default function ClientsSection() {
  const logos: ClientLogo[] = [
    { name: "PAMEX Essentials", src: "/images/clients/logo_pamex.png", href: "https://www.facebook.com/groups/perfumeadictosmexicoEssentials" },
    { name: "Grupo Formativo Estudiantil", src: "/images/clients/logo_grupoformativoestudiantil.png", href: "https://grupoformativoestudiantil.org/" },
    { name: "SeaJewels by ultrafemme", src: "/images/clients/logo_ultrafemme.jpg", href: "https://ultrafemme.com" },
    { name: "Entre Perfumes", src: "/images/clients/logo_entreperfumes.jpg" }, // sin link
    { name: "Perfumes 11:11", src: "/images/clients/logo_perfumes1111.png", href: "https://perfumes11-11.com" },
    { name: "Sekega", src: "/images/clients/logo_sekega.png", href: "https://sekega.com" },
  ]

  return (
    <section id="clientes" className="relative w-full py-16">
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-[#59C5B3]/10 via-white to-[#F7A23B]/10" aria-hidden />
