...
import { Calendar, Clock, ArrowRight, Newspaper, Zap, Rocket, User } from "lucide-react"
    ...
    <div className="relative w-full py-16 md:py-20 overflow-hidden bg-gradient-to-b from-white to-gray-50/50">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mx-auto mb-12 max-w-2xl text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-[#0F7A7E] sm:text-4xl">Blog GDMX</h1>
          <p className="mt-3 text-brand-ink/70">
            Todas las novedades, lanzamientos y mejoras de nuestra plataforma logística.
          </p>
        </div>
        ...
        <div className="mb-8">
          <nav className="flex items-center gap-2 text-sm text-brand-ink/60">
            ...
            <span>/</span>
            <span className="text-[#0F7A7E] font-medium">Blog</span>
          </nav>
        </div>
        ...
        {featuredPosts.length > 0 && (
          <div className="mb-12">
            <h2 className="text-xl font-semibold text-[#0F7A7E] mb-6 flex items-center gap-2">
